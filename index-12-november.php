...
<video id="banner-video" preload="auto" loop>
  ...
  <div class="playpause"></div>
   ...
   <div class="item">
            <img src="images/banner_truck.jpg" style="height: auto;width: 100%;" >
...
<!-- <div class="item">
    ...
    <img src="images/ban999.png" style="height: auto;width: 100%;" >
        <div class="carousel-caption">
            <div class="slider_content">
                        <h1 class="banmargin" style="margin-bottom:18%;"> 
                            <span>Premium Quality 
...
<div id="myModal" class="modal fade in" tabindex="-1" role="dialog" aria-hidden="true" style="display: block; padding-right: 0px;">
        <div class="modal-dialog">
            <div class="modal-content">
             <form id="EnquiryForm" name="EnquiryForm" action="/potauto/index.php" onsubmit="return EnquiryForm_validation();" method="POST" novalidate="">
