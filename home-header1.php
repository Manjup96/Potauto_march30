                    ...
                    <div class="offcanvas_menu_wrapper">
                       ...
                       <!--  <div class="header_top_links">
                        ...
                        <div id="menu" class="text-left ">
                            ...
                            <p><i class="icon-phone-call" aria-hidden="true"></i> <span>Call us: <a href="tel:08884463013" style="background-color:transparent;">08884463013</a></span></p>

                        </div>
                        <div class="call_support" style="color:#f9cf1f; font-weight: bold;font-size:15px">
                        <span><i class="fa fa-envelope-o" aria-hidden="true"></i>  
                        <a href="mailto:info@potauto.in" style="color:#f9cf1f;background-color:none;">
                            info@potauto.in
                            </a></span>
</div>
