        ...
        onsubmit="downloadPdf_Biolite_Catalogue('Download-Brouchre/Biolite-Catalogue.pdf','Biolite-Auto-Spareparts-Catalogue')"
          method="POST" novalidate="" >
             ...
             <input type="hidden" name="destination" value="<?php #echo $_SERVER["REQUEST_URI"]; ?>"/>
                ...
                <button id='closeModal' onclick="javascript:window.location.reload()" type="button" class="btn btn-danger" data-dismiss="modal" style="margin-right:-50px">Close</button>             
...
//         $('#modal_box_biolite').on('hidden.bs.modal', function () {
//  location.reload();
// })
