        ...
        <div class="col-md-3" style="color:white;text-align:left;padding: 3%;">
           <div class="footer_info">
            ...
            <li class="footer_phone" style="margin-bottom:5px" ><span>  &#128222;</span>
              ...
              <li><span><i class="fa fa-map-marker"></i> No: 5/1, 1st floor, Madanayakanahalli, Lakshmipura road,tumkur road, Bangalore-562123, Karnataka, India.</span></li>  
          </ul>
               </div>
           </div>
        <div class="col-md-3" style="color:white;text-align:left;padding:3%;">
 ...
 include("config.php");
  if(isset($_POST["submit_bulk_enquiry"]))       						
  {
   ...
   //if(isset($phone) && !empty($phone))
    if(isset($phone) || !empty($_POST['phone'])  || !empty($_POST['quantity']) || !empty($_POST['quotation_for']) || !empty($_POST['name']) || !empty($_POST['requirement']) )
    {
        
       // } //echo '<script>alert(isset($phone) && !empty($phone))</script>';
         //echo '<script>alert( !empty($phone))</script>';
        //echo(!empty($phone));
        //echo (isset($phone) && !empty($phone));
        //else
        //{
