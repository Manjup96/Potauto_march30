...
<head>
    ...
    <title>Potauto Auto Accessories - contact Us</title>
    ...
    <!--breadcrumbs area start-->
       ...
       <section class="slider_section">
        <div class="slider_area slider_carousel owl-carousel">
            ...
            <!--data-bgimg="images/contact-banner.png" >-->
               <div class="container">
                   <div class="row">
                       <div class="col-12">
    ...
    <div class="contact_page_bg">
        ...
        <div class="contact_map">
           <div class="map-area">
              ...
              <!--<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d242.91585664645606!2d77.45927919633681!3d13.05770076286102!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae25af9bce1c51%3A0x7a3079f018270acf!2sPotauto%20Auto%20India%20Pvt.%20Ltd!5e0!3m2!1sen!2sin!4v1656591811405!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>-->
              <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15546.614823035974!2d77.4595367!3d13.0577008!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x7a3079f018270acf!2sJIOMEX%20Auto%20India%20Pvt.%20Ltd!5e0!3m2!1sen!2sin!4v1673002556218!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-12">
                       <div class="contact_message content">
                            <h3 style="color:#f9cf1f;font-size:32px ">Contact Us</h3>   
                            <div class="contact-body" style="font-size:15px"> 
                             <p style="text-align:justify ;font-size:15px"> 
                                  Our customer service team is available from Monday to Saturday from 10:00 AM to 7:00 PM.

                                Please, write to <br> <div class="call_support text-right">
                                  <h5 style="text-align:left"> Email:
                                
                              
                                    <p style="font-weight:600;text-align:left"><i class="fa fa-envelope-o" aria-hidden="true"></i>  
                                     <a href="mailto:info@potauto.in">info@potauto.in</a>
                                        </p>
                                        </div>
                                    </h5>

                                    
                                <!-- <br> or use Contact Form,  available on website and application. </b><br> -->
                                    
                                 Potauto customer care number: <div class="call_support text-right">

                                 <div class="row">
                                 <p style="text-align:left"><i class="icon-phone-call" aria-hidden="true"></i> 
                                 <span style="text-align:left">  <a href="tel:08884463013">08884463013</a></span>
                                </p>
                                </div>
                            ...
                            <ul>
                                <li style="font-size:15px"><i class="fa fa-map-marker"></i>
                                        No: 5/1, 1st floor, Madanayakanahalli,<br/>Lakshmipura road, tumkur road,<br/> Bangalore-562123, <br/>Karnataka, India.
                                </li>
                    ...
                    <div class="col-lg-6 col-md-12" style="box-shadow: 0px 0px 7px 5px #27569eb5; padding: 10px;background-image: linear-gradient(300deg, #27569e, #a0bce7);">
                       <div class="contact_message form" >
                            <h3>Tell us your project</h3>   
                            <!-- <form id="contact_form" class="needs-validation" name="contact_form" method="POST" 
                                 action="<?php #echo htmlspecialchars($_SERVER['PHP_SELF']);?>" onsubmit="return contact_validation();" novalidate=""> -->
                                 <form class="needs-validation" id="contact_us" name="contact_us" 
                            ...
                            <div class=""> 
                                   <label> Your Name *</label>
                                    <input name="contact_us_name"  size="10" class="form-control" id="contact_us_name" placeholder="Name *"
                                     type="text" required onkeyup="contact_us_validateName()"> 
                                     <div class="invalid-feedback" id="contact_us_name_error" style="display:none"> Please Enter more than 5 characters for Name</div>
                                </div> 
                                
                                <div class="">         
                                   <label> Phone *</label>
                                    <input name="contact_us_phone" class="form-control" placeholder="Phone *" id="contact_us_phone" 
                                     type="number" required onkeyup="contact_us_validatePhone()">
                                    <div class="invalid-feedback" id="contact_us_phone_error" style="display:none"> Please enter 10-digit Phone Number </div>
                                </div>  
                    
                            
                            <div class="">
                            <label>Email *</label>
                             <input type="email" name="contact_us_email" id="contact_us_email" class="form-control"  
                            placeholder="Enter your Email" required onkeyup="contact_us_validateEmail()">
                             <div class="invalid-feedback"  id="contact_us_email_error" style="display:none">
                              ...
                              <div class="">
                                    ...
                                    <textarea placeholder="Message *" rows="2" cols="50" id="contact_us_message"
                                    onkeyup="contact_us_validateMessage()" 
                                     name="contact_us_message"  class="form-control" spellcheck="false" required> </textarea> 
                                    <div class="invalid-feedback"  id="contact_us_message_error" style="display:none"> Please Enter more than 5 Characters Message from contact form</div>
                                </div>
                            
                                <div class="col-md-4" style="justify-content: center;"> 
                                <!-- <input type="submit" name="submit1" class="btn btn-primary" 
                                style="background-color:#f9cf1f;border-radius:10px;justify-content: center;" id="submit1" value="submit"/> </div> -->
                                <button type="submit"  style="background-color:#f9cf1f;border-radius:10px;justify-content: center;" name="submit_contact_us"   id="submit_contact_us" disabled>Submit</button>
                                </div> 
...
<script>
   document.getElementById("submit_contact_us").disabled = true;

  var contact_us_phone_check=0,contact_us_name_check=0,contact_us_email_check=0,contact_us_message_check=0;
  var regEx = /\S+@\S+\.\S+/; // string, white-space, @ , white-space, dot, white-space, value, string //
     
  function contact_us_validatePhone()
  {
      ...
      if(phoneRegEX.test(phone))
        {
          ...
          document.getElementById("contact_us_phone_error").style.display = "none";
          contact_us_phone_check=1;
  
        } else
         
        { 
            document.getElementById("contact_us_phone_error").style.display = "block";  
         contact_us_phone_check=0;
        } 
  ...
  function contact_us_validateName(){
  ...
  if(nameRegEx.test(name))
    {
      // console.log("true");
    document.getElementById("contact_us_name_error").style.display="none";
    contact_us_name_check=1;
  }
  else
     {document.getElementById("contact_us_name_error").style.display="block"; 
     contact_us_name_check=0;
...
function contact_us_validateMessage(){
     var message = document.getElementById("contact_us_message").value;
     console.log("message=",message.length)
     if(message.length>5)
     {
         document.getElementById("contact_us_message_error").style.display="none";
         contact_us_message_check=1;
     }
     else
     {
          document.getElementById("contact_us_message_error").style.display="block";
          contact_us_message_check=0;
     }
     contact_us_Form_check();
...
function contact_us_validateEmail() {
    var email = document.getElementById("contact_us_email").value; //tenant
    ...
    if(emailRegEx.test(email))
    {
        ...
        if (regEx.test(email))
        {
            console.log("ph=",contact_us_phone_check,contact_us_name_check,contact_us_email_check);
        document.getElementById("contact_us_email_error").style.display ="none";
        contact_us_email_check=1;
        }

    }
    else
    {
        document.getElementById("contact_us_email_error").style.display = "block";
        contact_us_email_check=0;
    }
    contact_us_Form_check();
     
    }
    
    function contact_us_Form_check()
    {
        
 // alert("check= phone name ");
 if(contact_us_phone_check==1 && contact_us_name_check==1 && contact_us_email_check==1 && contact_us_message_check==1)
  {
      //alert("check=1");
      document.getElementById("submit_contact_us").disabled = false;
  }
  else{
      document.getElementById("submit_contact_us").disabled = true;
...
$name=trim($_POST['contact_us_name']);

$phone=trim($_POST['contact_us_phone']);
$email=trim($_POST['contact_us_email']);
$message=trim($_POST['contact_us_message']);
$error_msg="";
$id="";
 if(!empty($email))
     ...
     $sql = "INSERT INTO contact(id,name,email,phone,message) VALUES
     ...
     if ($conn->query($sql) === TRUE) 
     {
       ...
       "Phone : ".$phone .'<br/>' ."message : ".$message.'<br/><br/><br/>'."Regards".'<br/>'. "Potauto" .'<br/>'
...
<script>
  ...
  "brandSetting":{
      "brandName":"POTAUTOAuto India Pvt Ltd",
