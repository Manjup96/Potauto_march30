...
<link href="https://cdn.datatables.net/1.11.5/css/jquery.dataTables.min.css" rel="stylesheet">
	...
	<div class="col-sm-9 col-md-10 page-content">
			...
			<div class="panel panel-default">
                <div class="panel-heading"><h3>View Enquiry</h3>
<!-- <form class="form-horizontal" action="barcode_excel.php" method="post" name="upload_excel"   
		...
		?>
            ...
            <td width="160"> 
			    		 	<a class="btn btn-danger" style="padding:2px 4px !important;" href="del_enquiry.php?id=<?php echo $row["id"] ?>"> <i class="fa fa-trash white trash"></i> </a>
			    	</td>
