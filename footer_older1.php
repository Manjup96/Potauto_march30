   ...
   echo '<small class="error-1 error-2" id="" onclick="this.style.display = \'none\'">Please Enter Correct 10 digit Phone Number.</small>';
   ...
   else
    {
                    ...
                    if($conn->query($sql) === TRUE)
                    {
                        ...
                        $to1="enquiry@potauto.in";
      $subject1="New User Requested for Quotation";
      $from1="info@potauto.in";
      $message1= "Hi Team,".'<br/><br/>'."New User Enquired for quatation. Following are the User information.".'<br/><br/>'."Name : " . $name .'<br/>'."Phone : ".$phone .'<br/>'.
      "Category : ".$quotation_for .'<br/>' ."Quantity : ".$quantity.'<br/><br/><br/>'."Regards".'<br/>'. "Potauto" .'<br/>'
...
Thank you!!  Our Team will get back to you soon!! </span>
...
// echo '<div class="error-2 error-1" id="mydiv" onclick="this.style.display = \'none\'">Sorry Failed to send try again.</div>';
 ...
 //print_r(error_get_last());
                   ...
                   // echo '<div class="alert alert-success" style="position:absolute !important;top:50%; role="alert" id="mydiv" onclick="this.style.display = \'none\'"> We Will Get In Touch With You </div>';
                    }
                    
                    else
                    {
                         echo '<script>alert("Failed to insert Data")</script>';
                            //echo '<div class="alert alert-danger" style="position:absolute !important;top:50%;"role="alert" id="mydiv" onclick="this.style.display = \'none\'">  Sorry Failed to send Your Request ,Please try again. </div>';
