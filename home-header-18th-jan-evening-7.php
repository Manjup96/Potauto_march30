        ...
        onsubmit="Download_Brochure_Form_validation();downloadPdf('Download-Brouchre/Potauto-Catalogue.pdf','Potauto-Auto-Spareparts-Catalogue');"           method="POST" novalidate="">
          <input type="hidden" name="destination" value="<?php echo $_SERVER["REQUEST_URI"]; ?>"/>
                ...
                <div class="modal-body">
                              ...
                              <div class=""> 
                                   <labelclass="form-label"> Your Name *</label>
                                    <input name="name"  size="10" class="form-control" id="footerEnquiryName" placeholder="Name *" type="text" required onkeyup="validateName()"> 
                                     <div class="invalid-feedback" id="name_error" style="display:none"> Please Enter  characters only for Name</div>
                                </div> 
                                
                                <div class="">         
                                   <label> Phone *</label>
                                    <input name="phone" class="form-control" placeholder="Phone *" id="footerEnquiryPhone"  type="number" required onkeyup="validatePhone()">
                                    <div class="invalid-feedback" id="phone_error" style="display:none"> Please enter 10-digit Phone Number </div>
                                </div>  
                            ...
                            <label>Email *</label>
                             <input type="email" name="email" id="email" class="form-control"  
                            placeholder="Enter your Email" required onkeyup="validateEmail()">
                             <div class="invalid-feedback"  id="email_error" style="display:none"> Please Enter correct email</div> 
                    ...
                    <button type="submit" class="submit-button" name="submit"  id="submit_potauto"  disabled>Download</button>
...
<script>
  ...
  var phone_check=0,name_check=0,quantity_check=0,requirement_check=0,email_check=0;
  ...
  if( phone_check==1 && name_check==1 && email_check==1)
...
function validateEmail() {
    var email = document.getElementById("email").value; //tenant
    ...
    if(emailRegEx.test(email))
    {
        ...
        if (regEx.test(email))
        {
            console.log("ph=",phone_check,name_check,email_check);
          ...
          <input type="hidden" name="destination" value="<?php echo $_SERVER["REQUEST_URI"]; ?>"/> -->
             ...
             <input type="hidden" name="destination" value="<?php echo $_SERVER["REQUEST_URI"]; ?>"/>
                ...
                <div class="modal-body">
                            ...
                            <label>Email *</label>
                            <input type="email" name="email" id="email" class="form-control"  
                            placeholder="Enter your Email" required onkeyup="">
                    ...
                    <!--<input type="submit"  name="submit" id="submit" value="Submit" disabled
                      style="justify-content: center;color:#27569e;background:#f9cf1f"> -->
                    <!--<button onclick="document.getElementById('link').click()">Download!</button> -->
                    <button type="submit" class="submit-button2" name="submit"   id="submit_biolite" disabled>Download</button>
                            <!--id="submit_potauto"-->
                    </input>   
                   <!--  <button type="button"  name="submit" value="Submit Requirement"  class="btn btn-primary">Submit Requirement</button> -->
                    </div>
